...
const LOCALE_STORAGE_KEY = "trustnetdocs.locale";
...
const messages = {
  "pt-BR": {
    ...
    "auth.twoFactorTitle": "Confirme seu acesso",
    "auth.twoFactorSubtitle": "Informe o codigo gerado no seu aplicativo autenticador.",
    "auth.twoFactorSetupSubtitle": "Configure seu aplicativo autenticador antes de continuar.",
    "auth.twoFactorSetupInstructions": "Abra Microsoft Authenticator, Google Authenticator ou app compatível e adicione uma nova conta.",
    "auth.twoFactorSetupApps": "Escaneie o QR Code abaixo. Depois informe o codigo de 6 digitos gerado pelo app.",
    "auth.twoFactorSetupUriHint": "Se o app permitir importar URI otpauth, use a opcao de configuracao avancada.",
    "auth.twoFactorQrAlt": "QR Code para configurar autenticacao em dois fatores",
    "auth.twoFactorShowManual": "Nao consigo escanear. Mostrar chave manual",
    "auth.twoFactorHideManual": "Ocultar chave manual",
    "auth.twoFactorManualKey": "Chave de configuracao manual",
    "auth.twoFactorCode": "Codigo de verificacao",
    "auth.twoFactorCodePlaceholder": "000000",
    "auth.twoFactorUnavailable": "Nao foi possivel iniciar a autenticacao em dois fatores.",
    "auth.verifyCode": "Verificar codigo",
    "auth.backToLogin": "Voltar ao login",
    "auth.firstAccessTitle": "Primeiro acesso",
    "auth.firstAccessSubtitle": "Crie sua senha definitiva para ativar o acesso seguro.",
    "auth.newPassword": "Nova senha",
    "auth.newPasswordPlaceholder": "Minimo de 8 caracteres",
    "auth.confirmNewPassword": "Confirmar nova senha",
    "auth.confirmNewPasswordPlaceholder": "Repita a nova senha",
    "auth.completeFirstAccess": "Salvar senha e continuar",
    "auth.apiUnavailable": "API indisponível",
    "auth.apiHealthy": "API e banco {status}",
    "auth.languageLabel": "Idioma da tela",
  ...
  "en-US": {
    ...
    "auth.twoFactorTitle": "Confirm your access",
    "auth.twoFactorSubtitle": "Enter the code generated by your authenticator app.",
    "auth.twoFactorSetupSubtitle": "Set up your authenticator app before continuing.",
    "auth.twoFactorSetupInstructions": "Open Microsoft Authenticator, Google Authenticator, or a compatible app and add a new account.",
    "auth.twoFactorSetupApps": "Scan the QR Code below. Then enter the 6-digit code generated by the app.",
    "auth.twoFactorSetupUriHint": "If your app supports importing an otpauth URI, use the advanced setup option.",
    "auth.twoFactorQrAlt": "QR Code to set up two-factor authentication",
    "auth.twoFactorShowManual": "I cannot scan it. Show manual key",
    "auth.twoFactorHideManual": "Hide manual key",
    "auth.twoFactorManualKey": "Manual setup key",
    "auth.twoFactorCode": "Verification code",
    "auth.twoFactorCodePlaceholder": "000000",
    "auth.twoFactorUnavailable": "Two-factor authentication could not be started.",
    "auth.verifyCode": "Verify code",
    "auth.backToLogin": "Back to sign in",
    "auth.firstAccessTitle": "First access",
    "auth.firstAccessSubtitle": "Create your permanent password to activate secure access.",
    "auth.newPassword": "New password",
    "auth.newPasswordPlaceholder": "At least 8 characters",
    "auth.confirmNewPassword": "Confirm new password",
    "auth.confirmNewPasswordPlaceholder": "Repeat the new password",
    "auth.completeFirstAccess": "Save password and continue",
    "auth.apiUnavailable": "API unavailable",
    "auth.apiHealthy": "API and database {status}",
    "auth.languageLabel": "Screen language",
...
export function I18nProvider({ children }: { children: ReactNode }) {
  const [locale, setLocaleState] = useState<SupportedLocale>(() =>
    normalizeLocale(localStorage.getItem(LOCALE_STORAGE_KEY) ?? navigator.language)
  );
